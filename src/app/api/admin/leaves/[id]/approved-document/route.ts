...
export async function GET(
  ...
  if (
    ...
    return NextResponse.json(
      {
        error:
          "Storage dokumen tidak didukung.",
      },
      {
        status: 500,
      }
  ...
  try {
    ...
    return NextResponse.json(
      {
        error:
          "File dokumen final tidak ditemukan.",
      },
      {
        status: 404,
      }
...
export async function POST(
  ...
  if (
    ...
    return NextResponse.json(
      {
        error:
          "Dokumen final hanya digunakan untuk pengajuan Cuti.",
      },
      {
        status: 409,
      }
  ...
  try {
    ...
    if (
      ...
      return NextResponse.json(
        {
          error:
            "Pengajuan sudah berubah. Muat ulang halaman.",
        },
        {
          status: 409,
        }
