...
export async function POST(
  ...
  /*
   * Cegah pengajuan yang tanggalnya
   * bertumpuk dengan pengajuan aktif.
   *
   * REJECTED dan CANCELLED tidak dihitung.
   */
  const overlapping =
  ...
  if (overlapping) {
    return NextResponse.json(
      {
        error:
          "Sudah ada pengajuan lain pada rentang tanggal tersebut.",
      },
      {
        status: 409,
      }
